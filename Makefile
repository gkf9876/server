server : CustomObject.o CustomUser.o ChattingDB.o ManageMap.o dumper.o echo_epollserv.c
	gcc -o server CustomObject.o CustomUser.o ChattingDB.o ManageMap.o dumper.o echo_epollserv.c libtmx.a `xml2-config --libs` -lz -lpthread -lmysqlclient -o server
